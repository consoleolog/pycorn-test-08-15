...
# st.subheader("1️⃣ ✅ 공개 Google Sheet 읽기")
...
# csv_url1 = "https://docs.google.com/spreadsheets/d/1n1w5C2C_TB4eiPZoBcOTA1mtJ70MPJAX-lSuGUFQ8pQ/export?format=csv"
# df1 = pd.read_csv(csv_url1)
# st.dataframe(df1)

# st.subheader("2️⃣ 🔐 공개 Google Sheet 읽기")
